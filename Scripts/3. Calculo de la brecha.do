...
order codlocal nombreooii d_dpto d_prov d_dist ubigeo region pliego codue unidadejecutora /*nombentidad*/ codooii d_dreugel /*tipo_entidad*/ clas_digc clas_digc cant_total_2021 redes jec_2020 turno integracion rural_upp_2021 //Datos generales
...
foreach x in coord_adm_ie oficinista pers_limp_mant pers_vigilancia secretario /*aux_biblioteca aux_laboratorio aux_sistemas*/ {
    ...
    gen salario_`x' = 6*${sueldo_`x'} + 300 + 6*min(${sueldo_`x'}*0.09,4600*0.45*0.09)
...
global datos_generales "codlocal nombreooii	d_dpto d_prov d_dist ubigeo region pliego codue	unidadejecutora		codooii	d_dreugel clas_digc	cant_total_2021	redes jec_2020 turno integracion rural_upp_2021"
...
keep region pliego codue unidadejecutora /*tipo_entidad nombentidad*/ codooii d_dreugel pers_limp_mant pers_limp_mant_c pers_limp_mant_n req_pers_limp_mant exd_pers_limp_mant
...
collapse (sum) exd_pers_limp_mant_n exd_pers_limp_mant exd_pers_limp_mant_c req_pers_limp_mant , by(region pliego /*nombentidad*/ codooii d_dreugel)
